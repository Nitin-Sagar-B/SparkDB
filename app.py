...
# Get and set the API key from the user
api_key = set_api_key()

if api_key:  # Only proceed if API key is provided
    ...
    if option in ["Add Question", "View/Edit Questions"]:
        ...
        if questions:
            ...
            for q in questions:
                id, q_tag, q_question, q_answer, q_logic = q
                prompt = f"Generate a similar logical-thinking aptitude question to: {q_question}"
